...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/equilibrium-point-1587115620/1?page=1&category=Arrays&sortBy=submissions)

## Solved On
13 Aug 2026 at 09:15 pm

<h2><a href="https://www.geeksforgeeks.org/problems/equilibrium-point-1587115620/1?page=1&category=Arrays&sortBy=submissions">Equilibrium Point</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given an array of integers<strong> arr[]</strong>,<strong> </strong>the task is to find the first <strong>equilibrium point</strong>&nbsp;in the array.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>3 &lt;= arr.size() &lt;= 10<sup>5</sup><br><span style="font-size: 18.6667px;">-10</span><sup>4</sup> &lt;= arr[i] &lt;= 10<sup>4</sup></span></p>